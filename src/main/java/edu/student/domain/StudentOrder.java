...
public class StudentOrder {
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "givename", column = @Column(name = "h_given_name")),
    ...
    @AttributeOverrides({
            ...
            @AttributeOverride(name = "givename", column = @Column(name = "w_given_name")),
    ...
    private List<StudentOrderChild> childList;
    ...
    public List<StudentOrderChild> getChildList() {
        return childList;
    }

    public void setChildList(List<StudentOrderChild> childList) {
